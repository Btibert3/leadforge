...
:class:`~leadforge.schemes.lead_scoring.mechanisms.base.MechanismAssignment` produced by
:func:`~leadforge.schemes.lead_scoring.mechanisms.policies.assign_mechanisms`, and emits the full
...
- Stage advancement is driven by
  :class:`~leadforge.schemes.lead_scoring.mechanisms.transitions.HazardTransition`
  (mql → … → negotiation); final conversion is driven by
  :class:`~leadforge.schemes.lead_scoring.mechanisms.hazards.ConversionHazard`
...
from leadforge.schemes.lead_scoring.mechanisms.base import MechanismContext
...
from leadforge.schemes.lead_scoring.mechanisms.transitions import StageSequence
