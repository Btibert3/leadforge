...
motif family and constructs a
:class:`~leadforge.schemes.lead_scoring.mechanisms.base.MechanismAssignment`
...
from leadforge.schemes.lead_scoring.mechanisms.base import MechanismAssignment
...
from leadforge.schemes.lead_scoring.mechanisms.measurement import NoisyProxy
from leadforge.schemes.lead_scoring.mechanisms.scores import LatentScore
from leadforge.schemes.lead_scoring.mechanisms.transitions import HazardTransition
...
def assign_mechanisms(
    ...
    *,
    ...
    """Build a :class:`~leadforge.schemes.lead_scoring.mechanisms.base.MechanismAssignment`
    for *motif_family*.
    ...
    :func:`~leadforge.schemes.lead_scoring.structure.sampler.sample_hidden_graph`.
    ...
    Args:
        ...
        latent_touch_intensity: When ``True``, use
            :class:`~leadforge.schemes.lead_scoring.mechanisms.counts.LatentDecayIntensity` instead
            of :class:`~leadforge.schemes.lead_scoring.mechanisms.counts.RecencyDecayIntensity` for
